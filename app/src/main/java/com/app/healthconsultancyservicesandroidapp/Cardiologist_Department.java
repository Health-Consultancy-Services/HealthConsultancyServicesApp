    ...
    private void getEodReport() {
        ...
        call.enqueue(new Callback<List<Doctor>>() {
            ...
            public void onResponse(Call<List<Doctor>> call, Response<List<Doctor>> response) {
                ...
                departmentAdapter=new DepartmentAdapter(Cardiologist_Department.this,doctors);
                department_recyclerview.setAdapter(departmentAdapter);
                Toast.makeText(Cardiologist_Department.this,"Success",Toast.LENGTH_SHORT).show();
