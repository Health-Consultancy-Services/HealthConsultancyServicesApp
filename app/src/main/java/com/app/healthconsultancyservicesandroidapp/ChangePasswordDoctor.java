...
public class ChangePasswordDoctor extends AppCompatActivity {
    EditText _password,_oldpassword, _confirmpass;
    TextView _email,doctorname;
    Button _btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = bundle.getString("homepageDoctorName");
        String EmailID = bundle.getString("homepageDoctorEmailId");
    ...
    private void ChangePassword() {
        ...
        call.enqueue(new Callback<Integer>() {
            ...
            public void onResponse(Call<Integer> call, Response<Integer> response) {
                ...
                String newpassword = _password.getText ().toString ();
                if (message == 1){
                    Intent intent =new Intent(ChangePasswordDoctor.this, MainActivity.class);
