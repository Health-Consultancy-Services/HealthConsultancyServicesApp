...
public class Eyespecialist_Department extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eyespecialist__department);
    ...
    private void getEodReport() {
        ...
        call.enqueue(new Callback<List<Doctor>>() {
            ...
            public void onResponse(Call<List<Doctor>> call, Response<List<Doctor>> response) {
                ...
                departmentAdapter=new DepartmentAdapter(Eyespecialist_Department.this,doctors);
                department_recyclerview.setAdapter(departmentAdapter);
                Toast.makeText(Eyespecialist_Department.this,"Success",Toast.LENGTH_SHORT).show();
